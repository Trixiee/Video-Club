...
%>
	...
	<jsp:useBean id="zanroviBean" class="beans.GetSveZanroveBean"
	...
	<div class="container">
		<form action="/LibraryWeb/SaveSerijaServlet" method="post">
			<div class="form-group">
				<label for="naslov">Unesite naslov serije :</label> <input type="naslov"
					class="form-control" id="naslov" placeholder="naslov" name="naslov">

				<label for="autor">Unesite autora serije :</label> <input type="autor"
					class="form-control" id="autor" placeholder="autor"
					name="autor"> 
					
				<label for="godinaProizvodnjeSerije">Unesite datum proizvodnje serije
					:</label> <input type="date" class="form-control" id="godinaProizvodnjeSerije"
					placeholder="yyyy-MM-dd" name="godinaProizvodnjeSerije">
				 
				 <label
					for="produkcijsaKuca">Unesite ime produkcijeske kuce :</label> <input
					type="produkcijsaKuca" class="form-control" id="produkcijsaKuca"
					placeholder="produkcijsaKuca" name="produkcijsaKuca">
				
				 <label
					for="brojEpizodaSerije">Unesite broj epizoda serije:</label> <input
					type="brojEpizodaSerije" class="form-control" id="brojEpizodaSerije"
					placeholder="brojEpizodaSerije" name="brojEpizodaSerije">
				
				
				 <label
					for="zanr">Izaberite zanr  :</label> 
					</br>
					<td><select name="zanr">
							<c:forEach var="z" items="${zanroviBean.sviZanrovi}">
								<option value="${z.idZanr}">${z.nazivZanra}</option>
							</c:forEach>
					</select></td>
				</tr>
	...
	<c:if test="${!empty poruka}">
		<div class="porukastill">${poruka}</div>
	</c:if>
