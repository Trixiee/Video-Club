...
%>
	...
	<div class="container">
		<form action="/LibraryWeb/SaveFilmServlet" method="post">
			<div class="form-group">
				<label for="naslov">Unesite naslov filma :</label> <input type="naslov"
					class="form-control" id="naslov" placeholder="naslov" name="naslov">

				<label for="autor">Unesite autora filma :</label> <input type="autor"
					class="form-control" id="autor" placeholder="autor"
					name="autor"> 
					
				<label for="datumProizvodnjeFilma">Unesite datum proizvodnje filma
					:</label> <input type="date" class="form-control" id="datumProizvodnjeFilma"
					placeholder="yyyy-MM-dd" name="datumProizvodnjeFilma">
				 
				 <label
					for="produkcijskaKuca">Unesite ime produkcijeske kuce :</label> <input
					type="produkcijskaKuca" class="form-control" id="produkcijskaKuca"
					placeholder="produkcijskaKuca" name="produkcijskaKuca">
				 <label
