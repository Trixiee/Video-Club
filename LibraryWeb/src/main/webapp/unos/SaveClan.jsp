...
%>
	...
	<div class="container">
		<form action="/LibraryWeb/SaveClanServlet" method="post">
			<div class="form-group">
				<label for="ime">Unesite ime :</label> <input type="ime"
					class="form-control" id="ime" placeholder="ime" name="ime">

				<label for="prezime">Unesite prezime :</label> <input type="ime"
					class="form-control" id="prezime" placeholder="prezime"
					name="prezime"> <label for="adresa">Unesite adresu
					:</label> <input type="adresa" class="form-control" id="adresa"
					placeholder="adresa" name="adresa"> <label
					for="datumRodjenja">Unesite datum rodjenja :</label> <input
					type="date" class="form-control" id="datumRodjenja"
					placeholder="datumRodjenja" name="datumRodjenja"> <label
					for="datumUpisa">Unesite upisa :</label> <input type="date"
					class="form-control" id="datumUpisa" placeholder="datumUpisa"
					name="datumUpisa"
					value='<fmt:formatDate pattern="yyyy-MM-dd" value="${today}"/>'>

				<label for="Kategorija">Izaberite kategoriju :</label></br>
