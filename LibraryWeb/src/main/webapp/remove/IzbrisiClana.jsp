...
<title>Pretraga clana po id</title>
</head>
<body>
...
%>
	...
	<div class="container">
		<form action="/LibraryWeb/izbrisiClanaServlet" method="post">
			<div class="form-group">
				<label for="idClan">Unesite id clana :</label> <input type="idClan"
					class="form-control" id="idClan" placeholder="idClan" name="idClana">

			</div>
			</br>
			<button type="submit" class="btn btn-default">Izbrisi</button>
	</form>
	</div>
</body>
</html>