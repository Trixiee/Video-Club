...
<title>Pretraga serije po id-u</title>
...
%>
	...
	<div class="container">
		...
		<form action="/LibraryWeb/GetSerijaZaId" method="get">
			<div class="form-group">
				
				<label for="idSerija">Unesite id serije:</label> <input type="idSerija"
					class="form-control" id="idSerija" placeholder="idSerija" name="idSerija">
				</div>
			</br>
