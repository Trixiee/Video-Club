...
<title>Pretraga clana za datum upisa i kategoriju</title>
...
<div class="container">
		<form action="/LibraryWeb/GetClanKategorijaDatum" method="get">
			<div class="form-group">
				<label for="datumUpisa">Unesite datum upisa :</label> <input type="datumUpisa"
					class="form-control" id="datumUpisa" placeholder="datumUpisa" name="datumUpisa">
