...
<title>Pretraga filma po id-u</title>
</head>
<body>
...
<div class="container">
		<form action="/LibraryWeb/GetFilmZaId" method="get">
			<div class="form-group">
				<label for="idFilm">Unesite id filma :</label> <input type="idFilm"
					class="form-control" id="idFilm" placeholder="idFilm" name="idFilm">
