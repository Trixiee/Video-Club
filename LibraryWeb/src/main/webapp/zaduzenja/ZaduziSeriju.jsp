...
<div class="container">
  <form action="/LibraryWeb/ZaduzenjeSerijeServlet" method="post">
    <div class="form-group">
      <label for="idClana">Unesite id clana:</label>
      <input type="text" class="form-control" id="idClana" placeholder="idClana" name="idClana">
    </div>
    <div class="form-group">
      <label for="invBroj">Inventarni broj</label>
      <input type="text" class="form-control" id="invBroj" placeholder="invBroj" name="invBroj">
    </div>
