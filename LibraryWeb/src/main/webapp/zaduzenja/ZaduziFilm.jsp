...
<div class="container">
  <form action="/LibraryWeb/ZaduzenjeFilmaServlet" method="post">
    <div class="form-group">
      <label for="idClana">Unesite id clana:</label>
      <input type="idClana" class="form-control" id="idClana" placeholder="idClana" name="idClana">
    </div>
    <div class="form-group">
      <label for="invBroj">Inventarni broj</label>
      <input type="invBroj" class="form-control" id="invBroj" placeholder="invBroj" name="invBroj">
    </div>
    <button type="submit" class="btn btn-default">Zaduzi</button>
  </form>
</div>
