...
<div class="container">
  <form action="/LibraryWeb/RazduziSerijuServlet" method="post">
    <div class="form-group">
      <label for="idZaduzenja">Unesite id zaduzenja:</label>
      <input type="idZaduzenja" class="form-control" id="idZaduzenja" placeholder="idZaduzenja" name="idZaduzenja">
    </div>
    <button type="submit" class="btn btn-default">Razduzi</button>
  </form>
</div>
</body>
</html>