...
%>
	...
	<div class="container">
		<form action="/LibraryWeb/RazduziFilmServlet" method="post">
			<div class="form-group">
				<label for="idZaduzenja">Unesite id zaduzenja:</label> <input
					type="idZaduzenja" class="form-control" id="idZaduzenja"
					placeholder="idZaduzenja" name="idZaduzenja">
			</div>
