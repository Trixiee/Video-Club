...
<div class="container">
  <form action="/LibraryWeb/azurirajFilm" method="post">
    <div class="form-group">
      <label for="idFilm">Unesite id filma:</label>
      <input type="idFilm" class="form-control" id="idFilm" placeholder="idFilm" name="idFilm">
