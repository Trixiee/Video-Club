...
<div class="container">
  <form action="/LibraryWeb/azurirajSeriju" method="post">
    <div class="form-group">
      <label for="idSerija">Unesite id serije:</label>
      <input type="idSerija" class="form-control" id="idSerija" placeholder="idSerija" name="idSerija">
      <label for="produkcijskaKuca">Unesite novu produkcijsku kucu:</label>
      <input type="produkcijskaKuca" class="form-control" id="produkcijskaKuca" placeholder="produkcijskaKuca" name="produkcijskaKuca">
    </div>
    <button type="submit" class="btn btn-default">Azuriraj</button>
  </form>
</div>
