...
<div class="container">
<form action="/LibraryWeb/LoginServlet" >
			<div class="form-group">
				<label for="username">Unesite korisnicko ime :</label> <input type="username"
					class="form-control" id="username" placeholder="username" name="username">

				<label for="sifra">Unesite sifru :</label> <input type="password"
					class="form-control" id="sifra" placeholder="sifra"
					name="sifra"> 	
				</div>
		</br>
